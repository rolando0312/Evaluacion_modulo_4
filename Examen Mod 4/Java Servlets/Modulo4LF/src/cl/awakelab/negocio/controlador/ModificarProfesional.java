...
/**
 * Servlet implementation class ModificarProfessional
 */
@WebServlet("/ModificarProfesional")
public class ModificarProfesional extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int run = Integer.parseInt(request.getParameter("hdnidpro"));
		...
		boolean resultado = ProfessionalDao.actualizarProfesional(pro);
